...
export function InvoiceForm() {
  ...
  // Load customers, business profile, and next invoice number
  useEffect(() => {
    async function loadData() {
      try {
        const [customersRes, profileRes, nextNumRes] = await Promise.all([
          fetch('/api/gst/customers'),
          fetch('/api/business-profile'),
          fetch('/api/gst/invoices/next-number'),
        ]);
        ...
        // Set next invoice number from API
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Enter invoice number, date, and customer
            </CardDescription>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Add services with SAC codes and tax rates</CardDescription>
          </CardHeader>
          <CardContent>
            <Table>
              <TableHeader>
