 ...
 *
 * Extracted from page.tsx in Sprint 6.1.9c so the page can be a server
 * component that conditionally renders either this form (production)
 * or the two-account chooser (Docker self-host). Behaviour of this
 * component is byte-identical to the pre-6.1.9 page.
 *
